""" Using pygame library to create goal through the car's routine and cross the road """
import pygame
...
# the file of shame
def getGoals(): ## the getGoals function returns the list of goals.
    goals = []
    ...
    goals.append(goal24)
    ## The last goal in the list is marked as active (isactiv = True).
