""" Using pygame to create the wall in the gaming environment. These wall will follow the road of the (track.png) file """
import pygame
...
def getWalls(): ## the getWalls function returns the list of walls.
    walls = []
